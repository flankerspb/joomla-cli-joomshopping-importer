...
use JoomShoppingImporter\AbstractImporter;


define('_JEXEC', 1);
define('FL_JSHOP_IMPORTER', 1);

require_once(__DIR__ . '/src/AbstractImporter.php');
AbstractImporter::init();

$classes = AbstractImporter::$children;
...
if (count($actions) && count($importers))
{
	...
	{
		$importer = AbstractImporter::getInstance($key);
